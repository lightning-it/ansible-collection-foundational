...
- Required profiles: `pre-commit, lint, light, molecule-light, release-validation`.
- OS matrix: `ubuntu-latest`.
- Product/runtime matrix: `ansible-core, molecule`.
...
- Ansible Galaxy publishing is enabled for `lit.foundational` after trusted `main` release validation.
