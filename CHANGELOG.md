...
* sync shared assets from lightning-it/shared-assets ([#85](https://github.com/lightning-it/ansible-collection-foundational/issues/85)) ([19ab02c](https://github.com/lightning-it/ansible-collection-foundational/commit/19ab02c909578e6fb7e87e3fe3e6be02ef851056))
...
* sync shared assets from lightning-it/shared-assets ([#81](https://github.com/lightning-it/ansible-collection-foundational/issues/81)) ([f0e9adc](https://github.com/lightning-it/ansible-collection-foundational/commit/f0e9adc3d5c5ddc373039bfb1a69f3b288d24da0))
...
* fix: update semantic-release dependencies for improved stability ([348517f](https://github.com/lightning-it/ansible-collection-foundational/commit/348517f))

## <small>1.1.1 (2025-12-19)</small>

* fix: improve var handling ([b55d676](https://github.com/lightning-it/ansible-collection-foundational/commit/b55d676))

## 1.1.0 (2025-12-18)

* feat: initialize foundational Ansible collection with Terraform runner role ([055e44e](https://github.com/lightning-it/ansible-collection-foundational/commit/055e44e))
